#!/bin/bash
#SBATCH --job-name=gen_9_9_07
#SBATCH --output=/common/users/tdn39/Robotics/Mujoco/mujoco_env_creator/slurm_logs/gen_9_9_07_%j.out
#SBATCH --error=/common/users/tdn39/Robotics/Mujoco/mujoco_env_creator/slurm_logs/gen_9_9_07_%j.err
...
# Configuration
INPUT_DIR="/common/users/tdn39/Robotics/Mujoco/templates/Nov25/9_9_07deletion"
OUTPUT_DIR="/common/users/shared/robot_learning/dm1487/namo/mj_env_configs/nov28/9_9_07deletion"
